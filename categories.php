    ...
    <div class="container">
        ...
        <div class="explore-foods display-flex text-center">
            <div class="food col-third ">
                <a href="../project01/order.php"><img src="../project01/image/food-img/pizza.jpg" alt="Pizza"
                        class="food-img border-radius"></a>
                <p class="food-name">Pizza</p>
            </div>
            <div class="food col-third ">
                <a href="../project01/order.php"><img src="../project01/image/food-img/burger.jpg" alt="Burger"
                        class="food-img border-radius"></a>
                <p class="food-name">Burger</p>
            </div>
            <div class="food col-third ">
                <a href="../project01/order.php"><img src="../project01/image/food-img/momo.jpg" alt="Momo"
                        class="food-img border-radius"></a>
